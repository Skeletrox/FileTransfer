...
public class Encoder {
	...
	public void setInFileName(String s) throws FileNotFoundException
	{
		inName = s;
		setInFile();
	}
	public void setOutFileName(String s) throws Exception
	{
		outName = s;
		setOutFile();
	}
	...
	//To make it easier for GUI interfacing
	public Encoder(String pw,int len)
	{
		passScan = new Scanner(System.in);
		genPass = new RC4Gen();
		genPass.setKey(pw);
		genPass.setOPLength(len);
		genPass.scheduleKey();
		genPass.generatePseudoRandom(false);
		outKey = genPass.getOutput();
	}
	...
	private void setInFile() throws FileNotFoundException
	{
		//try
		//{
	...
	private void setOutFile() throws Exception
	{
		//try
		//{
